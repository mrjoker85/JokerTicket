...
module.exports = {
  ...
  errorEmbed: function(message, channel, argument) {
    channel.send(new Discord.MessageEmbed().setDescription(`\\📛 **Error:** ${argument} \\📛`).setColor(`RED`))
  },

  successEmbed: function(message, channel, argument) {
    channel.send(new Discord.MessageEmbed().setDescription(`\\✅ **Movafaghiat Amiz Bood:** ${argument}`).setColor(`GREEN`))
  },
